...
public class SensitiveAPICategory {
	...
	{
		//lejos APIs
		sensitiveAPICategories.put("<lejos.robotics.SampleProvider: void fetchSample(float[],int)>", "EV3 fetches sample data");
		sensitiveAPICategories.put("<lejos.robotics.EncoderMotor: void setPower(int)>", "EV3 sets motor power");
